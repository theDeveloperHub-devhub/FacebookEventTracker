...
define([
    ...
    return function (config) {
        ...
        window.fb = function() {
            ...
            } else if ($('.devhub-subscribe-email').text()) {
                fbq('init', id, {
                    em : $('.devhub-subscribe-email').text()
                });
            } else {
                fbq('init', id);
            }

            if ($('.devhub-subscribe-email').text()) {
                fbq('track', 'Subscribe', {
                    id : $('.devhub-subscribe-id').text()
                });

                $('.devhub-subscribe-id').text('');
                $('.devhub-subscribe-email').text('');
            }
