...
namespace DeveloperHub\FacebookEventTracker\Model;
...
class Session extends SessionManager
{
    ...
    {
        $this->setData('devhub_action_page', $data);
        return $this;
    }
    ...
    public function getActionPage()
    {
        if ($this->hasActionPage()) {
            $data = $this->getData('devhub_action_page');
            $this->unsetData('devhub_action_page');
            return $data;
        }
        return null;
    }
    ...
    {
        return $this->hasData('devhub_action_page');
    }
}
